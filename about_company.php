...
<html lang="ru">
   ...
   <head>
      ...
      <title>О компании - ФХ “Applefield”, Applefield</title>
                  ...
                  <div class="row">
                     <div class="col-12 col-md-8">
                        <div class="header-left d-flex flex-column flex-md-row align-items-center">
                           <p class="d-flex align-items-center"><a href="mail:export@Applefield.by" class="contact-line-field"><i class="fas fa-envelope"></i>export@Applefield.by</a></p>
                                          ...
                                          <div class="wcu-block">
                                             <div class="wcu_intro">
                                                <p>В распоряжении нашей компании находится собственное хранилище,
                                                   вместимостью на 100 000 тонн продукции.
                                                </p>
                                             </div>
                                          </div>
                                       </div>
