...
<head>
    ...
    <title>Продукция - ФХ “Applefield”, Gretsky</title>
      ...
      <div class="ogami-breadcrumb">
        <div class="container">
          <ul>
            ...
            <li> <a class="breadcrumb-link active">Сушеные фисташки</a></li>
          </ul>
        </div>
      </div>
      <!-- End breadcrumb-->
                ...
                <div class="shop-products">
                  ...
                  <div class="shop-products_bottom">
                    <div class="row no-gutters-sm">
                      <?php
                      $sql="SELECT * FROM `product` WHERE `type_n` = 4 AND `If_fried` = 1 ORDER BY name ASC"; 
                  ...
                  <div class="col-6 col-md-4">
                    <div class="product">
                      ...
                      <div class="product-info_block">
                          ...
                          <a class="product-name" href="../product/product_page.php?<?php echo $row['id'] ?>">
                            <?php echo $row['name'] ?>
                          </a>
