...
<head>
    ...
    <title><?php echo $row['type'] ?> - ФХ “Applefield”, Applefield</title>
            ...
            <div class="row">
              <div class="col-12 col-md-8">
                <div class="header-left d-flex flex-column flex-md-row align-items-center">
                  <p class="d-flex align-items-center"><a href="mail:expy" class="contact-line-field"><i class="fas fa-envelope"></i>export@apple.by</a></p>
                  <p class="d-flex align-items-center"><a href="tel:+370407" class="contact-line-field url-phone"><i class="fas fa-phone"></i>+375 00 000 00 00</a></p>
                ...
                <div class="mobile-menu_block d-flex align-items-center"><a class="mobile-menu--control" href="#"><i class="fas fa-bars"></i></a>
                  <div id="ogami-mobile-menu">
                    ...
                    <div class="mobile-login">
                      <a href="tel:+37" class="url-phone"><i class="fas fa-phone"></i> +375 00 000 00 00</a>
                      <a href="mail:expo"><i class="fas fa-envelope"></i> export@apple.by</a>
                    </div>
                ...
                <div class="col-12 col-sm-4 text-sm-center text-md-left">
                 ...
                 <div class="col-12 col-sm-4 text-sm-center text-md-left">
                    <div class="footer-quicklink">
                       ...
                       <a href="../catalog/lesnoy.html">Лесной яблоко</a>
                 ...
                 <div class="col-12 col-sm-4 text-sm-center text-md-left">
                    <div class="footer-quicklink">
                       ...
                       <a href="../catalog/obzh_lesnoy.php">Лесной яблоко</a>
