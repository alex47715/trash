...
<div class="shop-sidebar_department">
  ...
  <div class="department_bottom">
    <ul>
      <li> <a class="department-link" href="../catalog/fistashki.php">Джоногоред</a></li>
      <li> <a class="department-link" href="../catalog/funduk.php">Муцу</a></li>
      <li> <a class="department-link" href="../catalog/gretskiy_oreh.php">Голден</a></li>
      <li> <a class="department-link" href="../catalog/mindal.php">Чемпион</a></li>
    </ul>
  </div>
</div>
<div class="shop-sidebar_department">
  ...
  <div class="department_bottom">
    <ul>
      <li><a class="department-link" href="../catalog/obzh_lesnoy.php">Муцу</a></li>
      <li><a class="department-link" href="../catalog/obzh_fistashki.php">Джоногоред</a></li>
    </ul>
  </div>
</div>
              </div>
                 ...
                 <div class="row">
                    <div class="col-12 col-sm-4 text-sm-center text-md-left">
                       <div class="footer-quicklink">
                          ...
                          <a href="../catalog/about_company.php">О компании</a>
                          <a href="../catalog/blog.php">Новости</a>
                          <a href="../catalog/contact.php">Контакты</a>
                       </div>
                    </div>
                    <div class="col-12 col-sm-4 text-sm-center text-md-left">
                       <div class="footer-quicklink">
